...
<body>
	...
	<form:form action="manage_supplier_edit" method="post"
		commandName="supplierEditForm">
		<table>
			<tr>
			...
			<tr>
				<td><form:label path="id">Supplier name</form:label></td>
				<td><form:input path="name"></form:input></td>
			</tr>

			<tr>
				<td><form:label path="id">Supplier Address</form:label></td>
